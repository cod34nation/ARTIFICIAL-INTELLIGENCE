...
public class greedy {
 ...
 // int koin[] = untuk menampung banyaknya koin yang ingin ditukar
 // int uang = untuk menampung uang yang ingin ditukar
 // int jum =  menampung batas iterasi
 ...
 void solusiMax_Min(int data[],int jum[], int uang)
    {
...
class main
{
 ...
 {
  BufferedReader entri = new BufferedReader(new InputStreamReader(System.in));
  try{
  ...
  System.out.print("Masukkan batas solusi: ");
  ...
  g.solusiMax_Min(hasil,jum,uang);
 }catch(Exception e)
 {
